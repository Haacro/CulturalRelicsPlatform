...
public final class ActivityDetailsBinding implements ViewBinding {
  ...
  private ActivityDetailsBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull Toolbar detailToobar, @NonNull WebView webView) {
  ...
  public static ActivityDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailsBinding((LinearLayoutCompat) rootView, detailToobar, webView);
    }
