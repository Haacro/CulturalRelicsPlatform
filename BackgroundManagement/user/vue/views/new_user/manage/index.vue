<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['new_user:manage:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['new_user:manage:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['new_user:manage:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['new_user:manage:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="manageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户登录密码" align="center" prop="password" />
      <el-table-column label="用户电子邮箱" align="center" prop="email" />
      ...
      <el-table-column label="用户上次登录时间" align="center" prop="lastLoginAt" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户登录密码" prop="password">
          <el-input v-model="form.password" placeholder="请输入用户登录密码" />
        </el-form-item>
        <el-form-item label="用户电子邮箱" prop="email">
          <el-input v-model="form.email" placeholder="请输入用户电子邮箱" />
        </el-form-item>
        ...
        <el-form-item label="用户上次登录时间" prop="lastLoginAt">
          <el-date-picker clearable
...
<script>
import { listManage, getManage, delManage, addManage, updateManage } from "@/api/new_user/manage";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('new_user/manage/export', {
        ...this.queryParams
